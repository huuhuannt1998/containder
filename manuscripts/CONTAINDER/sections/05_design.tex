...
We separate three compatibility levels and test each rather than asserting ``backward
compatible.'' \emph{Protocol compatibility}: 2030.5 messages remain standard conformant.
