...
\begin{table}[t]
\centering
\caption{Security invariants implemented by the prototype (real X.509/mTLS). All ten pass; \emph{Key} is the
identifier emitted in \texttt{results/credsvc.json}, whose numbering skips I6 and runs to I11.}
\label{tab:invariants}
\small
\begin{tabular}{@{}p{0.05\columnwidth}p{0.55\columnwidth}p{0.20\columnwidth}c@{}}
\toprule
ID & Invariant & Key & Result \\
\midrule
I1 & Bootstrap identity cannot authorize control & \texttt{I1} & pass \\
I2 & Issuance requires a fresh attestation & \texttt{I2} & pass \\
I3 & Credential bound to a fresh public key & \texttt{I3} & pass \\
I4 & Replayed evidence rejected & \texttt{I4} & pass \\
I5 & Expired credential cannot issue a command & \texttt{I5} & pass \\
I6 & Scope enforced per command & \texttt{I7} & pass \\
I7 & Bad measurement yields degraded/denied scope & \texttt{I8} & pass \\
I8 & Prior epoch cannot self-renew & \texttt{I10} & pass \\
I9 & Copied prior key fails after rotation & \texttt{I11} & pass \\
I10 & Active session/command bounded past expiry & \texttt{I9} & pass \\
\bottomrule
\end{tabular}
\end{table}
